    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Image.asset("assets/img/verify.png",scale:5 ,),
            SizedBox(height: width * 0.12,),
            Text("Verify Your Number",textAlign: TextAlign.center,style: TextStyle(fontSize: width * 0.07,fontWeight: FontWeight.bold),),
            SizedBox(height: width * 0.08,),
            Text("Please enter your number to verify your account and proceed",textAlign: TextAlign.center,style: TextStyle(color: Colors.grey,fontSize: width * 0.04,fontWeight: FontWeight.w500),),
